...
Command: npx gltfjsx@6.2.16 bike.gltf 
*/
...
const Bike = (props) => {
 ...
 // Faz uma alteração nas malhas/mesh
  ...
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Bike.geometry} material={materials.Quadro}>
        ...
        <group position={[-1.047, -1.181, 0.005]} rotation={[Math.PI / 2, 0, 0]} scale={[0.792, 0.546, 0.792]}>
          <mesh ref={firstMesh} geometry={nodes.Torus003.geometry} material={materials.Pneu} />
        ...
        <mesh
        ref={secondMesh}
         geometry={nodes.B_Raios.geometry} material={materials.Raio} position={[-1.053, -1.178, 0.005]} />
        ...
        <group position={[1.905, -1.181, 0.005]} rotation={[Math.PI / 2, 0, 0]} scale={[0.792, 0.546, 0.792]}>
        ...
        <mesh geometry={nodes.F_Raios.geometry} material={materials.Raio} position={[1.899, -1.178, 0.005]} />
